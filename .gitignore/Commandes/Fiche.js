...
exports.run = (bot, msg, args) => {
	...
	.addField("Histoire", "Accompagné de son fidèle compagnon Sif, le loup gris, il va trouver Manus au fond des abysses et livrer une bataille épique avec cet ancien humain maintenant par les Ténèbres. Artorias va perdre et se faire corrompre à son tour par les ténèbres. Dans un dernier geste il va protéger Sif avec son bouclier empêchant tout contacte avec le loup, mais lui enlevant par la même occasion toutes ses chance de fuite ainsi que son bras gauche. Depuis ce jour Artorias erre seul avec pour seul souvenir Sif sans se rappeler de ce qu’il lui est arriver ni quand c'est arriver.")
